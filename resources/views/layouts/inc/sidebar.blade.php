      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white  {{ Request::is('categories') ? 'active' : '' }}" href="{{url('categories')}}">
            ...
            <span class="nav-link-text ms-1">Kategori Makanan</span>
          </a>
        </li>
        <li class="nav-item ">
          <a class="nav-link text-white {{ Request::is('add-category') ? 'active' : ''}} " href="{{url('add-category')}}">
            ...
            <span class="nav-link-text ms-1">Tambahkan Kategori</span>
          </a>
        </li>
        <li class="nav-item ">
          <a class="nav-link text-white {{ Request::is('products') ? 'active' : ''}} " href="{{url('products')}}">
            ...
            <span class="nav-link-text ms-1">List Makanan</span>
          </a>
        </li>
        <li class="nav-item ">
          <a class="nav-link text-white {{ Request::is('add-product') ? 'active' : ''}} " href="{{url('add-product')}}">
            ...
            <span class="nav-link-text ms-1">Tambahkan Makanan</span>
          </a>
        </li>
        <li class="nav-item ">
