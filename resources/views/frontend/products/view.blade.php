        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <hr>
                    <label for="" class="me-3">Harga Awal  : <s>Rp {{$product->original_price}}</s></label>
                    <label for="" class="fw-bold">Setelah diskon  : Rp {{$product->selling_price}}</label>
                    <p class="mt-3">
                    ...
                    <hr>
                    @if($product->qty > 0)
                        <label for="" style="background:rgba(234,88,11,255); color:white;" class="badge">Ada Stok</label>
                    @else
                        <label for="" class="badge bg-danger">Habis</label>
                    @endif
                    <div class="row mt-2">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-10">
                            <br/>
                            @if($product->qty > 0)
                            <button class="btn btn-outline-primary me-3 float-start addToCartButton">Beli <i class="fa-solid fa-cart-plus"></i></button>
                            @endif
                        </div>
                    </div>
                </div>
