        ...
        <div class="col-md-12">
            <div class="card p-4">
                <div class="card-head">
                    ...
                    <h4 class="my-2">Orderan Saya</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <label for="" class="my-1">Nama Depan</label>
                            <div class="border p-2 ">{{$order->fname}}</div>
                            <label for="" class="my-1">Nama Belakang</label>
                            <div class="border p-2">{{$order->lname}}</div>
                            <label for="" class="my-1">Email</label>
                            <div class="border p-2">{{$order->email}}</div>
                            <label for="" class="my-1">Nomor telphone</label>
                            <div class="border p-2">{{$order->phoneno}}</div>
                            <label for="" class="my-1">Alamat</label>
                            ...
                            <label class="my-1" for="">Kode Pos</label>
